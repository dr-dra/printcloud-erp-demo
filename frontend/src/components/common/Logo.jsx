      ...
      {showName && (
        <Typography
          sx={[
            ...
            navColor !== 'vibrant' && {
              background: ({ palette, direction }) =>
                direction === 'rtl'
                  ? `linear-gradient(100.06deg, #20DE99 93.03%, #7DB1F5 27.63%, #5A9EF6 49.36%, #4D595E 50.11%, #4D595E 87.87%)`
                  : `linear-gradient(100.06deg, #20DE99 6.97%, #7DB1F5 27.63%, #5A9EF6 49.36%, ${palette.text.secondary} 50.11%, ${palette.text.secondary} 87.87%);`,
